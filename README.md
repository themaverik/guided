...
Author image-driven A4 guidebooks in a two-pane WYSIWYG editor — chapters, steps, and
row-based screenshot grids with callouts, annotations, watermarks, and pixel-accurate
print/PDF output.
